...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>Parabéns! , você <p>'+ userScore +'</p> acertou <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        let scoreTag = '<span>Boa , você <p>'+ userScore +'</p> acertou <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{ // if user scored less than 1
        let scoreTag = '<span>Desculpe , você <p>'+ userScore +'</p> acertou <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
